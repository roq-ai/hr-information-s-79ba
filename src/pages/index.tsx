  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Discover HR Information System v2 - Your ultimate solution for managing employee data, vacations, and payroll efficiently and seamlessly."
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Discover HR Information System v2 - Your ultimate solution for managing employee data, vacations, and payroll efficiently and seamlessly.`}
            </Text>
            <Box
